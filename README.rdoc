...
On Red Hat, CentOS, Fedora, and Amazon Linux the default website (aka the Apache HTTPD test page) is enabled by default. For all other platforms, it is disabled by default.

To enable or disable it, set +[:apache][:default_site]+ to either true or false as desired.
